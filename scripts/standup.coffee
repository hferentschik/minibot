...
#
# Commands:
#   minibot standup? - show help for the standup
#   minibot <who> is a member of <team> - tell hubot who is the member of <team>'s standup
#   minibot standup for <team> - start the standup for <team>
#   minibot cancel standup - cancel the current standup
#   minibot next - say when your updates for the standup is done
#   minibot skip <who> - skip someone when they're not available
#
# Author:
#   @miyagawa
